...
Revision ID: d7c2df9ef34b
Revises: 
Create Date: 2025-10-05 15:43:52.642186
...
def upgrade() -> None:
    ...
    sa.Column('lesson_type', sa.Enum('UNKNOWN', 'LECTURE', 'PRACTICE', 'SEMINAR', 'LAB', 'EXAM', name='lesson_type'), nullable=False),
...
def downgrade() -> None:
    ...
    lesson_type_enum.drop(op.get_bind(), checkfirst=True)
    # ### end Alembic commands ###
